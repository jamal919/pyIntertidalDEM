...
#preprep.genstat(...)
#preprep.genmask(wkdir,prepdir,nstd=0.5,water=10000,land=5000,png=True)
...
for zone in Zones:
    ...
    for df in DataFolders:
        ...
        #improc.make_watermap(directory,improcdir,prepdir,zone,nhue=0.4,nvalue=5.0,png=True)
