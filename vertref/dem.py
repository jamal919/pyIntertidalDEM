...
class Dem(object):
    ...
    def find_closest(self, nodes, csvfile):
        '''
        find_closest finds the nearest lon,lat point from wl nodes for all the points
