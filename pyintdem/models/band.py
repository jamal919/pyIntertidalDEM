...
class Band(object):
    ...
    def position(self, xyloc, epsg=4326, center=True, saveto=None):
        ...
        Args:
            xyloc: [array-like, array-like] for a 2d array
            epsg: integer, optional, default: 4326
            center: boolean, if the points to be shifted to center of the pixel, optional, default: True
            saveto: save to a file
